...
'Buka tab Gangguan / Har TM'
WebUI.comment('Buka tab  Gangguan / Har TM')

WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/tab Gangguan  Har TM'))
...
WebUI.comment('Gangguan Jaringan')

WebUI.comment('Gardu')

'Klik Angka Gardu'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/G_Gardu'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

WebUI.comment('Penyulang')
...
'Klik Angka Penyulang'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/G_Penyulang'))
...
'Klik Angka Trafo'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/G_Trafo'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

WebUI.comment('Lainnya')
...
'Klik Angka Lainnya'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/G_Lainnya'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

WebUI.comment('Pemeliharaan Jaringan')

WebUI.comment('Gardu')

'Klik Angka Gardu'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/P_Gardu'))
...
'Klik Angka Penyulang'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/P_Penyulang'))
...
'Klik Angka Trafo'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/P_Trafo'))
...
'Klik Angka Lainnya'
WebUI.click(findTestObject('Outage/Monitoring/Gangguan Har TM/P_Lainnya'))
...
WebUI.comment('menunggu data bisa di klik')
