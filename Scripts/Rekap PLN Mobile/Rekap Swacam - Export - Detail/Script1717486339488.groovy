...
WebUI.click(findTestObject('Rekap/Rekap Swacam/button_EXPORT'))
...
'Cari Rekap Swacam'
WebUI.click(findTestObject('Rekap/Rekap Swacam/Page_(VCC) Virtual Command Center by PLN/Cari Rekap Swacam'))

WebUI.setText(findTestObject('Rekap/Rekap Swacam/Page_(VCC) Virtual Command Center by PLN/Cari Rekap Swacam'), '521020036636')
