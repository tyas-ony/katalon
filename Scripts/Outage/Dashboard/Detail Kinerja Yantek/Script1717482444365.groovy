...
WebUI.comment('Buka Halaman Detail Kinerja Yantek ')
...
WebUI.click(findTestObject('Object Repository/Outage/Dashboard/Detail Kinerja Yantek/a_Detail Kinerja Yantek'))
