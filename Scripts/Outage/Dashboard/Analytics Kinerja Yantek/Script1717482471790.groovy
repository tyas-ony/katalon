...
WebUI.comment('Buka Halaman Analisis Kinerja Yantek')
...
'Buka Halaman Analisis Kinerja Yantek'
WebUI.click(findTestObject('Object Repository/Outage/Dashboard/Analisis Kinerja Yantek/a_Analisis Kinerja Yantek'))
