...
'Pilih Induk Banten'
WebUI.click(findTestObject('Rekap/Rekap Pelanggan/Status/Pilih Banten'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

WebUI.comment('Status di level bawah belum sesuai, nunggu update dlu baru buat report')
