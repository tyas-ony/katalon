...
'Menampilkan informasi Level User Login'
...
WebUI.comment('Filter Regional/Induk/Area akan terdefault sesuai dengan level user login')

'Pilih Tanggal Awal'
WebUI.click(findTestObject('Outage/Dashboard/Rating Negatif Internal/Page_(VCC) Virtual Command Center by PLN/Tanggal Awal'))

'Pilih Tahun'
WebUI.click(findTestObject('Outage/Dashboard/Rating Negatif Internal/Page_(VCC) Virtual Command Center by PLN/Pilih Tahun Bulan'))

'Pilih Tahun 2021'
WebUI.click(findTestObject('Outage/Dashboard/Rating Negatif Internal/Page_(VCC) Virtual Command Center by PLN/Tahun 2021'))

'Pilih Bulan'
WebUI.click(findTestObject('Outage/Dashboard/Rating Negatif Internal/Page_(VCC) Virtual Command Center by PLN/Previous Month'))

WebUI.click(findTestObject('Outage/Dashboard/Rating Negatif Internal/Page_(VCC) Virtual Command Center by PLN/Previous Month'))

'Pilih Tanggal'
WebUI.click(findTestObject('Outage/Dashboard/Rating Negatif Internal/Page_(VCC) Virtual Command Center by PLN/Tanggal 1'))
