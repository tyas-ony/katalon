...
WebUI.comment('Buka Halaman Displin Input Time')
...
'Buka Halaman Displin Input Time'
WebUI.click(findTestObject('Outage/Dashboard/Disiplin Input Time/a_Dicipline Input Time'))
