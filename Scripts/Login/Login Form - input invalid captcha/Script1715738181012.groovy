...
WebUI.comment('Menampilkan pesan ketika pengguna salah input captcha')

WebUI.verifyElementPresent(findTestObject('Page_Login Form/div_ErrorMohon periksa kembali kode Captcha yang anda masukan.Ok'), 
    0)
