...
WebUI.comment('Buka halaman Outage Keluhan')
...
WebUI.click(findTestObject('Outage/Keluhan/a_WO Sedang Ditindak Lanjuti'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

//'Cari data WO Sedang Ditindak Lanjuti'
//WebUI.setText(findTestObject('Outage/Keluhan/WO Sedang/Cari WO Sedang'), 'ULP TELUK')
//
