...
WebUI.click(findTestObject('Outage/Keluhan/a_WO Belum Ditindak Lanjuti'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

//'Cari data WO Belum Ditindak Lanjuti'
//WebUI.setText(findTestObject('Outage/Keluhan/WO Belum/Cari WO Belum'), 'ULP CIBINONG')
//
