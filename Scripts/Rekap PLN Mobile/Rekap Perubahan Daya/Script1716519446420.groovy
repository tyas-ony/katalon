...
'Klik Data "Riau dan Kepri"'
WebUI.click(findTestObject('Object Repository/Rekap/Rekap Perubahan Daya/Pilih Riau dan Kepri'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

'Klik Data Area "Bangkinang"'
WebUI.click(findTestObject('Rekap/Rekap Perubahan Daya/Page_(VCC) Virtual Command Center by PLN/Pilih Bangkinang'))

WebUI.waitForPageLoad(5)

WebUI.takeFullPageScreenshot()

'Klik data Unit Bangkinang'
WebUI.click(findTestObject('Rekap/Rekap Perubahan Daya/Page_(VCC) Virtual Command Center by PLN/Pilih Unit Bangkinang'))
...
WebUI.click(findTestObject('Rekap/Rekap Perubahan Daya/Page_(VCC) Virtual Command Center by PLN/Cari Rekap Perubahan Daya'))

WebUI.setText(findTestObject('Rekap/Rekap Perubahan Daya/Page_(VCC) Virtual Command Center by PLN/Cari Rekap Perubahan Daya'), 
    '13885604')
...
WebUI.click(findTestObject('Rekap/Rekap Perubahan Daya/button_DETAIL'))

WebUI.verifyElementPresent(findTestObject('Rekap/Rekap Perubahan Daya/Detail Rekap Perubahan Daya'), 0)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Rekap/Rekap Perubahan Daya/button_Informasi Pengguna'))
