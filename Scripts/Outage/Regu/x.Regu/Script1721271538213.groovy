...
WebUI.comment('Buka Halaman Total Regu Aktif')

WebUI.click(findTestObject('Object Repository/Outage/Regu/Regu Bertugas/div_OutageOutage ManagementDashboardTindak _97fe5d'))

'Buka Halaman Total Regu Aktif'
WebUI.click(findTestObject('Outage/Regu/a_Total Regu Aktif'))
...
'Cari Data'
WebUI.setText(findTestObject('Outage/Regu/Total Regu Aktif/Cari Total Regu Aktif'), 'juwiring')
...
'Klik WA Petugas\r\n'
WebUI.click(findTestObject('Outage/Regu/Total Regu Aktif/a_PETUGAS'))

'Klik Maps\r\n\r\n'
WebUI.click(findTestObject('Outage/Regu/Total Regu Aktif/a_MAPS'))

WebUI.switchToWindowTitle('(VCC) Virtual Command Center by PLN')

'Klik Nama Regu'
WebUI.click(findTestObject('Outage/Regu/Total Regu Aktif/button_Nama Regu'))

'Menampilkan Detail '
WebUI.verifyElementPresent(findTestObject('Outage/Regu/Total Regu Aktif/div_Detail Regu'), 0)
