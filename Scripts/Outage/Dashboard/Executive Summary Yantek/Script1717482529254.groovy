...
WebUI.comment('Buka Halaman Executive Summary Yantek')
...
'Executive Summary Yantek'
WebUI.click(findTestObject('Outage/Dashboard/Executive Summary Yantek/a_Executive Summary Yantek'))
