...
'Pilih Area Manado'
WebUI.click(findTestObject('Rekap/Rekap Pengaduan/brdsrkan user login/Pilih Manado'))
...
'Pilih Unit Amurang'
WebUI.click(findTestObject('Rekap/Rekap Pengaduan/brdsrkan user login/Pilih Amurang'))
